...
import 'package:one_ride_car_owner/controller/hire_driver_start_screen_controller.dart';
        ...
        bottomNavigationBar: ScaffoldBottomBarWidget(
            child: controller.hiredDriverDetails.status == 'started'
                ? CustomStretchedButtonWidget(
                    onTap: () {},
                    child: Text(
                      AppLanguageTranslation.startedTransKey.toCurrentLanguage,
                      style: const TextStyle(color: Colors.white),
                    ))
                : controller.hiredDriverDetails.status == 'break'
                    ? CustomStretchedButtonWidget(
                        child: Text(
                        AppLanguageTranslation.breakTransKey.toCurrentLanguage,
                        style: const TextStyle(color: Colors.white),
                      ))
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Expanded(
        ...
        isReadOnly: false,
        suffixIcon:
            const SvgPictureAssetWidget(AppAssetImages.arrowLeftSVGLogoLine),
        boxHeight: 55,
