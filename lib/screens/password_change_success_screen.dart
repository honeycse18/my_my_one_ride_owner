import 'package:one_ride_car_owner/controller/passward_changed_controller.dart';
              ...
              children: [
                ...
                AppGaps.hGap56,
                 HighlightAndDetailTextWidget(
                    ...
                    isSpaceShorter: true,
                    slogan: AppLanguageTranslation.passChangedTransKey.toCurrentLanguage,
                    subtitle:
                        AppLanguageTranslation.notWorryTransKey.toCurrentLanguage),
                AppGaps.hGap30,
              ],
            ),
          ),
