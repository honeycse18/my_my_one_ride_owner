...
import 'package:one_ride_car_owner/controller/verification_screen_controller.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              HighlightAndDetailTextWidget(
                                  ...
                                  subtextColor: AppColors.mainTextColor,
                                  slogan: AppLanguageTranslation.verificationTransKey.toCurrentLanguage,
                                  subtitle:
                                      '${AppLanguageTranslation.verificationCodeTransKey.toCurrentLanguage} ${controller.isEmail ? AppLanguageTranslation.emailTransKey.toCurrentLanguage : AppLanguageTranslation.phoneTransKey.toCurrentLanguage}. ${AppLanguageTranslation.whichIsTransKey.toCurrentLanguage} ${controller.isEmail ? controller.theData["email"] : controller.theData["phone"]}'),
                            ],
                          ),
                        ),
                        AppGaps.hGap40,
                        ...
                        Center(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(AppLanguageTranslation.resendCodeTransKey.toCurrentLanguage),
                ...
                child: Column(
                  ...
                  children: [
                    CustomStretchedTextButtonWidget(
                        buttonText: AppLanguageTranslation.verifyOtpTransKey.toCurrentLanguage,
                    ...
                    TextButton(
                        ...
                        child:  Text(AppLanguageTranslation.resendTransKey.toCurrentLanguage,
