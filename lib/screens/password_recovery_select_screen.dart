...
import 'package:one_ride_car_owner/widgets/screen_widget/password_recovery_select_screen_widgets.dart';
    ...
    return Scaffold(
            ...
            children: [
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    AppGaps.hGap20,
                    Text(AppLanguageTranslation.resetPassTransKey.toCurrentLanguage,
                        textAlign: TextAlign.center,
                        style: Theme.of(context).textTheme.displaySmall),
                    AppGaps.hGap16,
                    Text(
                        AppLanguageTranslation.chooseOptionTransKey.toCurrentLanguage,
                        textAlign: TextAlign.center,
              ...
              Center(
                ...
                children: [
                  SelectResetPasswordWidget(
                    titleText: AppLanguageTranslation.sendYourMailTransKey.toCurrentLanguage,
                    contentText:
                        AppLanguageTranslation.passwordResetTransKey.toCurrentLanguage,
                  ...
                  AppGaps.hGap24,
                  SelectResetPasswordWidget(
                    titleText: AppLanguageTranslation.sendPhoneNumberTransKey.toCurrentLanguage,
                    contentText:
                        
                        AppLanguageTranslation.passwordResetLinkTransKey.toCurrentLanguage,
      ...
      bottomNavigationBar: CustomScaffoldBottomBarWidget(
        child: CustomStretchedTextButtonWidget(
            buttonText: AppLanguageTranslation.resetPasswordTransKey.toCurrentLanguage,
