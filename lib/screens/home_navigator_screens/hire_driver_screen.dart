...
import 'package:one_ride_car_owner/controller/home_navigator/hire_driver_screen_controller.dart';
...
import 'package:one_ride_car_owner/widgets/screen_widget/hire_driver_list_Widget.dart';
    ...
    return GetBuilder<HireDriverScreenController>(
        ...
        builder: (controller) => Scaffold(
                                  ...
                                  children: [
                                    ListTabStatusWidget(
                                      text: RideDriverTabStatus
                                          .driverPending.stringValueForView,
                                      isSelected: controller
                                              .hireDriverStatusTab.value ==
                    ...
                    switch (controller.hireDriverStatusTab.value) {
                      case RideDriverTabStatus.driverPending:
                        return PagedSliverList.separated(
                          ...
                          builderDelegate:
                              PagedChildBuilderDelegate<HireDriverListItem>(
                            ...
                            final HireDriverListItem hireDriverListItemPending =
                                item;
                            ...
                            return HireDriverListItemWidget(
                              ...
                              driverName: hireDriverListItemPending.driver.name,
                              rateType: hireDriverListItemPending.type,
                              startAddress: hireDriverListItemPending.pickup,
                              startDate: Helper.ddMMMyyyyFormattedDateTime(
                                  hireDriverListItemPending.start.date),
                      ...
                      case RideDriverTabStatus.started:
                        return PagedSliverList.separated(
                          ...
                          builderDelegate:
                            ...
                            return HireDriverListItemWidget(
                              onTap: () {
                                Get.toNamed(AppPageNames.hireDriverStartScreen,
                                    arguments: hireDriverListItemPending.id);
                              },
                              rate: hireDriverListItemPending.amount,
                              driverImage:
            ...
            floatingActionButton: FloatingActionButton.extended(
              ...
              label: Text(
                  AppLanguageTranslation.hireADriverTransKey.toCurrentLanguage,
